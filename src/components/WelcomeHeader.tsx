  ...
  return (
    <div className="relative mb-12 flex flex-col items-center justify-center px-4 pt-8 text-center sm:mb-16">
      ...
      >
        ...
        <div className="relative flex h-24 w-24 items-center justify-center rounded-4xl bg-linear-to-br from-white/20 to-white/5 shadow-2xl ring-1 ring-white/30 backdrop-blur-2xl sm:h-32 sm:w-32">
          <CloudSun
            size={60}
            strokeWidth={1.5}
      ...
      >
        <h1 className="relative mb-3 inline-block">
          <span className="bg-linear-to-b from-white via-white to-white/40 bg-clip-text text-4xl font-black tracking-[0.2em] text-transparent uppercase sm:text-6xl md:text-7xl">
            The Weather Channel
          </span>
          {/* Accent Line */}
          <div className="mt-2 h-1 w-full scale-x-50 rounded-full bg-linear-to-r from-transparent via-blue-400 to-transparent opacity-50" />
        </h1>
      </motion.div>
